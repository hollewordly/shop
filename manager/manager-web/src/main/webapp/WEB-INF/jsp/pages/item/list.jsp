...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/list.js" charset="utf-8"></script>
    ...
    <div class="layui-row">
        <div class="layui-form layui-col-md12 we-search">
            ...
            <div class="layui-inline">
                <input type="text" id="title" name="title" placeholder="请输入商品名称" autocomplete="off" class="layui-input">
            </div>
...
<%--
    ...
    <script type="text/html" id="barDemo">
        <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:;"><i class="layui-icon">&#xe642;</i>编辑</a>
