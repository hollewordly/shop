	...
	table.render({
		...
		cols: [
			[{
				...
				field: 'pro_id',title: 'ID',sort: true
			}, {
				field: 'pro_name',title: '商品名称',templet: '#usernameTpl'
			}, {
				field: 'pro_price',title: '商品价格',sort: true
			}, {
				field: 'pro_desc',title: '商品描述',sort: true
			}, {
				field: 'pro_date',title: '上架时间',sort: true
			}, /*{
